...
BOT_TOKEN = environ.get('BOT_TOKEN', '6342532407:AAEMK4l6VCyo8HZR_egZwX-WaeBRK8EZlt4')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6038518360').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002080820818').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://heyme106:4dVEjnIWMiaGTEWK@heyme106.479c2kr.mongodb.net/?retryWrites=true&w=majority")
...
NO_RESULTS_CHANNEL = int(environ.get("NO_RESULTS_CHANNEL", "-1002053895244"))
...
S_GROUP = environ.get('S_GROUP',"https://t.me/godmode_SUPPORT")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/MLZ_BOTZ")
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/godmode_SUPPORT")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺...')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', 0))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002059464806'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Godmode_SUPPORT')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002053895244')).split()]
